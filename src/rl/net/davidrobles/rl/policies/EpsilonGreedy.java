...
/**
 * An Epsilon Greedy policy. Takes a greedy action with a '1 - epsilon'
 * probability, or random action otherwise.
 *
 * @param <S>
...
public class EpsilonGreedy<S, A> implements RLPolicy<S, A> {
	...
	/**
	 * The random policy used to take the random actions (random value <
	 * epsilon).
	 */

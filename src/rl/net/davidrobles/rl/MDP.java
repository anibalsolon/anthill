...
public interface MDP<S, A> {
	...
	// returns a map (nextState, probability) representing the states reachable
	// from 'state'
	...
	// and moving to the given next state. Not available in reinforcement
	// learning.
	...
	// state as having a self-loop action 'pass' with zero reward; the
	// formulations
	// are equivalent.
